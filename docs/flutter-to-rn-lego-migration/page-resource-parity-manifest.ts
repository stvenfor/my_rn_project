...
export const PAGE_PARITY_ENTRIES: PageParityEntry[] = [
  ...
  {id: 'bfui-gallery', module: 'bfui', flutterPath: 'packages/features/bfui/lib/bfui_module.dart', rnRoute: 'BfuiGallery', rnComponent: 'BfuiGalleryScreen', status: 'Migrated', note: 'All Services → BFUI 模板目录; 17 catalog rows by category'},
