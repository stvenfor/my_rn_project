...
export const PAGE_PARITY_ENTRIES: PageParityEntry[] = [
  ...
  {id: 'home-page', module: 'home', flutterPath: 'packages/features/home/lib/home/view/home_page.dart', rnRoute: 'HomeTab', rnComponent: 'HomeScreen', status: 'Migrated', note: 'Greeting→Search→TopTab; used-car entry uses LoginRedirect gate'},
  ...
  {id: 'home-check-in-mall', module: 'home', flutterPath: 'packages/features/home/lib/home/view/check_in_mall_page.dart', rnRoute: 'HomeCheckInMall', rnComponent: 'HomeCheckInMallScreen', status: 'Migrated', note: 'Gift section empty on Flutter+RN mock'},
  ...
  {id: 'home-strategy', module: 'home', flutterPath: 'packages/features/home/lib/home/view/strategy_page.dart', rnRoute: 'HomeStrategy', rnComponent: 'HomeStrategyScreen', status: 'Migrated'},
  {id: 'home-dubbing-feed', module: 'home', flutterPath: 'packages/features/home/lib/home/view/dubbing_home_page.dart', rnRoute: 'HomeDubbingFeed', rnComponent: 'HomeDubbingFeedScreen', status: 'Migrated', note: 'Expert+Editor sections; media/hot-rank taps → DubbingVideoDetail; scrollToHotRank'},
  {id: 'home-hot-rank-detail', module: 'home', flutterPath: 'packages/features/home/lib/home/view/hot_rank_detail_page.dart', rnRoute: 'HomeHotRankDetail', rnComponent: 'HomeHotRankDetailScreen', status: 'Migrated', note: 'Row tap → DubbingVideoDetail; age filter still cosmetic like Flutter mock'},
  ...
  {id: 'classroom-class-homework-stats', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/class_homework_stats_page.dart', rnRoute: 'ClassroomHomeworkStats', rnComponent: 'ClassHomeworkStatsScreen', status: 'Migrated', note: 'Tabs + summary + student list; custom time sheet Degraded'},
  {id: 'classroom-homework-detail-student', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/homework_detail_student_page.dart', status: 'Deferred', owner: 'rn-team', targetVersion: 'v0.3', note: 'Flutter classroom module; RN detail not in all-services entry path'},
  {id: 'classroom-homework-detail-teacher', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/homework_detail_teacher_page.dart', status: 'Deferred', owner: 'rn-team', targetVersion: 'v0.3', note: 'Flutter classroom module; RN detail not in all-services entry path'},
  {id: 'classroom-homework-review', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/homework_review_page.dart', rnRoute: 'ClassroomHomeworkReview', rnComponent: 'HomeworkReviewScreen', status: 'Migrated', note: 'SvipRewardDialog simplified to Toast'},
  {id: 'classroom-dubbing-homework', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/dubbing_homework_page.dart', status: 'Deferred', owner: 'rn-team', targetVersion: 'v0.3', note: 'Flutter classroom module; RN @features/classroom partial'},
  {id: 'classroom-video-detail', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/video_detail_page.dart', status: 'Deferred', owner: 'rn-team', targetVersion: 'v0.3', note: 'Flutter classroom module; RN @features/classroom partial'},
  {id: 'classroom-claim-gift-card', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/claim_gift_card_page.dart', status: 'Deferred', owner: 'rn-team', targetVersion: 'v0.3', note: 'Flutter classroom module; RN @features/classroom partial'},
];
