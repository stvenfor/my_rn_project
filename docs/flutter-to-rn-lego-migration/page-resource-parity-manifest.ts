...
export const PAGE_PARITY_ENTRIES: PageParityEntry[] = [
  ...
  {id: 'auth-login', module: 'auth', flutterPath: 'packages/features/auth/lib/user/view/login_page.dart', rnRoute: 'Login', rnComponent: 'LoginScreen', status: 'Migrated', note: '1:1 email+password / phone+OTP; session via MockAuthService; real UserAuthApi Deferred when USE_MOCK_AUTH=false still mocks'},
  ...
  {id: 'auth-register', module: 'auth', flutterPath: 'packages/features/auth/lib/user/view/register_page.dart', rnRoute: 'Register', rnComponent: 'RegisterScreen', status: 'Migrated', note: '1:1 iOS register; remember-credentials Flutter feature Deferred'},
  ...
  {id: 'home-all-services', module: 'home', flutterPath: 'packages/features/home/lib/home/view/all_services_page.dart', rnRoute: 'HomeAllServices', rnComponent: 'HomeAllServicesScreen', status: 'Migrated', note: '相对 Flutter 其他服务多 BFUI Gallery、Invite Friend 两项，为 B8 故意保留；跳转仅 RoutePath'},
  ...
  {id: 'home-dubbing-feed', module: 'home', flutterPath: 'packages/features/home/lib/home/view/dubbing_home_page.dart', rnRoute: 'HomeDubbingFeed', rnComponent: 'HomeDubbingFeedScreen', status: 'Migrated', note: '装饰图已接线；history/文案/2列grid 见 packages/features/home/DEGRADE-home-dubbing-visuals.md'},
  {id: 'home-hot-rank-detail', module: 'home', flutterPath: 'packages/features/home/lib/home/view/hot_rank_detail_page.dart', rnRoute: 'HomeHotRankDetail', rnComponent: 'HomeHotRankDetailScreen', status: 'Migrated', note: 'wheat/TOP20/rank badge 已接线；header 渐变布局 Degraded 见 DEGRADE-home-dubbing-visuals.md'},
  ...
  {id: 'community-page', module: 'community', flutterPath: 'packages/features/community/lib/community/view/community_page.dart', rnRoute: 'CommunityTab', rnComponent: 'CommunityScreen', status: 'Migrated', note: 'iOS CommunityTheme; large title+search+filters; grouped PostCard; like/comment/share; mock repo'},
  {id: 'community-publish', module: 'community', flutterPath: 'packages/features/community/lib/community/view/publish_page.dart', rnRoute: 'CommunityPublish', rnComponent: 'CommunityPublishScreen', status: 'Migrated', note: 'Placeholder copy matches Flutter (发帖接口未接)'},
  {id: 'community-image-preview', module: 'community', flutterPath: 'packages/features/community/lib/community/view/image_preview_page.dart', rnRoute: 'ImagePreview', rnComponent: 'ImagePreviewScreen', status: 'Migrated', note: 'Shared gallery swipe + n/total title via chat ImagePreviewScreen'},
  {id: 'community-video-play', module: 'community', flutterPath: 'packages/features/community/lib/community/view/video_play_page.dart', rnRoute: 'CommunityVideoPlay', rnComponent: 'CommunityVideoPlayScreen', status: 'Degraded', note: 'WebView video + tap toggle; http(s) sanitize+attr escape; unmount teardown; no native scrubber'},

  {id: 'settings-mine', module: 'settings', flutterPath: 'packages/features/settings/lib/mine/view/mine_page.dart', rnRoute: 'MineTab', rnComponent: 'MineScreen', status: 'Migrated', note: 'Header+QuickServices+FunctionGrid+MenuList; used_car/short_video via LoginRedirect; logout reset→Login'},
  {id: 'settings-settings', module: 'settings', flutterPath: 'packages/features/settings/lib/settings/view/settings_page.dart', rnRoute: 'Settings', rnComponent: 'SettingsScreen', status: 'Migrated', note: 'Flutter DEV order Dialog→Linking→Realtime→IM; Live/Friend/Pay smoke appended (B9)'},
  ...
  {id: 'friend-page', module: 'friend', flutterPath: 'packages/features/friend/lib/friend/view/friend_page.dart', rnRoute: 'Friend', rnComponent: 'FriendScreen', status: 'Migrated', note: 'Intentional stub parity with Flutter friend_page; Settings __DEV__ smoke entry'},
  {id: 'live-page', module: 'live', flutterPath: 'packages/features/live/lib/live/view/live_page.dart', rnRoute: 'Live', rnComponent: 'LiveScreen', status: 'Migrated', note: 'Room list smoke; production WS Deferred; Settings __DEV__ entry'},
  {id: 'live-room', module: 'live', flutterPath: 'packages/features/live/lib/live/view/live_room_page.dart', rnRoute: 'LiveRoom', rnComponent: 'LiveRoomScreen', status: 'Migrated', note: '@core/realtime MockRealtimeAdapter only; A/V streaming Deferred; DebugRealtime → Mock room'},
  {id: 'pay-page', module: 'pay', flutterPath: 'packages/features/pay/lib/pay/view/pay_page.dart', rnRoute: 'Pay', rnComponent: 'PayScreen', status: 'Migrated', note: 'Layout+MockPayService; WeChat/Alipay SDK Deferred v0.2; Settings __DEV__ entry'},
  {id: 'pay-membership', module: 'pay', flutterPath: 'packages/features/pay/lib/membership/view/membership_renew_page.dart', rnRoute: 'PayMembership', rnComponent: 'MembershipRenewScreen', status: 'Migrated', note: 'All Services entry; native pay SDK Deferred'},
  ...
  {id: 'video-dubbing-list', module: 'video', flutterPath: 'packages/features/video/lib/dubbing/view/dubbing_video_list_page.dart', rnRoute: 'DubbingVideoList', rnComponent: 'DubbingVideoListScreen', status: 'Migrated', note: 'AppNavBar showBackButton; card list → detail'},
  {id: 'video-dubbing-work-list', module: 'video', flutterPath: 'packages/features/video/lib/dubbing/view/dubbing_work_list_page.dart', rnRoute: 'DubbingWorkList', rnComponent: 'DubbingWorkListScreen', status: 'Migrated', note: 'AppNavBar showBackButton; 2-col grid → detail'},
  {id: 'video-dubbing-detail', module: 'video', flutterPath: 'packages/features/video/lib/dubbing/view/dubbing_video_detail_page.dart', rnRoute: 'DubbingVideoDetail', rnComponent: 'DubbingVideoDetailScreen', status: 'Migrated', note: 'PlayableVideoHeader+sections+bottom bar; album Part switches URL; WebView scrubber Degraded; unmount teardown+URL sanitize'},
  {id: 'video-dubbing-work-detail', module: 'video', flutterPath: 'packages/features/video/lib/dubbing/view/dubbing_work_detail_page.dart', rnRoute: 'DubbingWorkDetail', rnComponent: 'DubbingWorkDetailScreen', status: 'Migrated', note: 'Header+tabs intro/comments+bottom bar; WebView scrubber Degraded'},
  ...
  {id: 'bfui-gallery', module: 'bfui', flutterPath: 'packages/features/bfui/lib/bfui_module.dart', rnRoute: 'BfuiGallery', rnComponent: 'BfuiGalleryScreen', status: 'Migrated', note: 'All Services → BFUI 模板目录; 17 catalog rows; Flutter UI shell also in home_screen.dart (embedded by navigation_home_screen; not a separate GetX business page)'},
  {id: 'bfui-intro', module: 'bfui', flutterPath: 'packages/features/bfui/lib/introduction_animation/introduction_animation_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'IntroAnimationTemplate', status: 'Migrated', note: 'Card-shell preview + WorkSans; AppNavBar back'},
  {id: 'bfui-hotel-home', module: 'bfui', flutterPath: 'packages/features/bfui/lib/hotel_booking/hotel_home_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'HotelBookingTemplate', status: 'Migrated', note: 'Card-shell listing; hotel_1–5 assets; calendar/filters Degraded'},
  {id: 'bfui-hotel-filters', module: 'bfui', flutterPath: 'packages/features/bfui/lib/hotel_booking/filters_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'HotelFiltersTemplate', status: 'Migrated', note: 'Chip/stat shell; no real range slider'},
  {id: 'bfui-fitness-home', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/fitness_app_home_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'FitnessAppTemplate', status: 'Migrated', note: 'Hero+stats shell; tab bar animation Degraded'},
  {id: 'bfui-my-diary', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/my_diary/my_diary_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'MyDiaryTemplate', status: 'Migrated', note: 'Meals use breakfast/lunch assets; water glass Degraded'},
  {id: 'bfui-training', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/training/training_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'TrainingTemplate', status: 'Migrated', note: 'List shell'},
  {id: 'bfui-design-course', module: 'bfui', flutterPath: 'packages/features/bfui/lib/design_course/home_design_course.dart', rnRoute: 'BfuiTemplate', rnComponent: 'DesignCourseTemplate', status: 'Migrated', note: 'Course thumbs via interFace assets'},
  {id: 'bfui-course-info', module: 'bfui', flutterPath: 'packages/features/bfui/lib/design_course/course_info_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'CourseInfoTemplate', status: 'Migrated', note: 'Hero image + Roboto title'},
  ...
  {id: 'bfui-invite', module: 'bfui', flutterPath: 'packages/features/bfui/lib/invite_friend_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'InviteFriendTemplate', status: 'Migrated', note: 'All Services + Gallery entry'},
  {id: 'bfui-nav-drawer', module: 'bfui', flutterPath: 'packages/features/bfui/lib/navigation_home_screen.dart', rnRoute: 'BfuiTemplate', rnComponent: 'NavigationDrawerTemplate', status: 'Migrated', note: 'Static menu shell; slide drawer gesture Degraded'},
  {id: 'bfui-glass', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/ui_view/glass_view.dart', rnRoute: 'BfuiTemplate', rnComponent: 'GlassViewTemplate', status: 'Degraded', note: 'Frosted card placeholder; no BackdropFilter blur'},
  {id: 'bfui-wave', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/ui_view/wave_view.dart', rnRoute: 'BfuiTemplate', rnComponent: 'WaveViewTemplate', status: 'Degraded', note: 'Circle % placeholder; no CustomPainter wave'},
  {id: 'bfui-running', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/ui_view/running_view.dart', rnRoute: 'BfuiTemplate', rnComponent: 'RunningViewTemplate', status: 'Degraded', note: 'Bar chart shell + runner asset'},
  {id: 'bfui-workout', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/ui_view/workout_view.dart', rnRoute: 'BfuiTemplate', rnComponent: 'WorkoutViewTemplate', status: 'Degraded', note: 'Weekly bars shell'},
  {id: 'bfui-mediterranean', module: 'bfui', flutterPath: 'packages/features/bfui/lib/fitness_app/ui_view/mediterranean_diet_view.dart', rnRoute: 'BfuiTemplate', rnComponent: 'MediterraneanDietTemplate', status: 'Degraded', note: 'Segment bars shell; catalog status shell'},
  ...
  {id: 'classroom-homework-detail-student', module: 'classroom', flutterPath: 'packages/features/classroom/lib/view/homework_detail_student_page.dart', rnRoute: 'ClassroomHomeworkDetailStudent', rnComponent: 'HomeworkDetailStudentScreen', status: 'Migrated', note: 'Tasks + dubbing/gift; progress from completionRate'},
