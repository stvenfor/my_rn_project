...
export const PAGE_PARITY_ENTRIES: PageParityEntry[] = [
  ...
  {id: 'community-video-play', module: 'community', flutterPath: 'packages/features/community/lib/community/view/video_play_page.dart', rnRoute: 'CommunityVideoPlay', rnComponent: 'CommunityVideoPlayScreen', status: 'Degraded', note: 'WebView video + tap toggle; no native scrubber/controls bar vs Flutter AppVideoControlsBar'},
  ...
  {id: 'video-dubbing-detail', module: 'video', flutterPath: 'packages/features/video/lib/dubbing/view/dubbing_video_detail_page.dart', rnRoute: 'DubbingVideoDetail', rnComponent: 'DubbingVideoDetailScreen', status: 'Migrated', note: 'PlayableVideoHeader+sections+bottom bar; WebView scrubber Degraded'},
